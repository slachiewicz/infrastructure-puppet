...
class Revision(Change):
    ...
    def _compute_values(self):
        ...
        values['num'] = self.num
        values['tot'] = self.tot
        values['recipients'] = ", ".join(self.recipients)
        if self.cc_recipients:
...
class ConfigOptionsEnvironmentMixin(ConfigEnvironmentMixin):
    ...
    def __init__(self, config, **kw):
        ...
        from_addr = "%s@apache.org" % committer
    ...
    def get_fromaddr(self, change=None):
        fromaddr = "%s@apache.org" % committer
        if change:
...
class StaticRecipientsEnvironmentMixin(Environment):
    ...
    def __init__(
        ...
        self.__refchange_recipients = recips
        self.__announce_recipients = recips
        self.__revision_recipients = recips
