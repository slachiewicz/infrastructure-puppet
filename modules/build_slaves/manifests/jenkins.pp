...
class build_slaves::jenkins (
  ...
  $gradle_versions = ['3.5', '4.3.1', '4.4.1', '4.8.1'],
  # $maven_old = ['apache-maven-3.0.4','apache-maven-3.2.1'],
  $maven = ['apache-maven-2.2.1', 'apache-maven-3.0.4', 'apache-maven-3.0.5', 'apache-maven-3.2.1', 'apache-maven-3.2.5', 'apache-maven-3.3.3', 'apache-maven-3.3.9', 'apache-maven-3.5.0' , 'apache-maven-3.5.2' , 'apache-maven-3.5.4'], # lint:ignore:140chars
  ...
  $java_asfpackages = ['harmony-jdk-713673' , 'jdk1.5.0_22-32', 'jdk1.5.0_22-64', 'jdk1.6.0_20-32-unlimited-security', 'jdk1.6.0_45-64', 'jdk1.7.0-32', 'jdk1.7.0-64', 'jdk1.7.0_25-32', 'jdk1.7.0_25-64', 'jdk1.7.0_79-unlimited-security', 'jdk1.7.0_80', 'jdk1.8.0_66-unlimited-security', 'jdk1.8.0_121', 'jdk1.8.0_131', 'jdk1.8.0_144' , 'jdk1.8.0_144-unlimited-security' , 'jdk1.8.0_152' , 'jdk1.8.0_172' , 'jigsaw-jdk-9-ea-b156', 'jdk-9-ea-b179' , 'jdk-9-b181' , 'jdk-9-b181-unlimited-security' , 'IBMJava2-142' , 'IBMJava2-amd64-142' , 'ibm-java2-i386-50' , 'ibm-java-i386-60' , 'ibm-java2-x86_64-50' , 'ibm-java-x86_64-60', 'ibm-java-x86_64-70', 'ibm-java-x86_64-80' , 'jdk-9.0.1' , 'jdk-10-ea+36' , 'jdk-10_46' , 'jdk-10.0.1' , 'jdk-11-ea+8' , 'jdk-11-ea+19'], # lint:ignore:140chars
) {
  ...
  file { "/home/${build_slaves::username}/tools/ant/latest1.9":
    ensure => link,
  ...
  file { "/home/${build_slaves::username}/tools/jiracli/latest":
    ...
    target => '/usr/local/asfpackages/jiracli/atlassian-cli-6.9.0',
  }
  ...
  file { "/home/${build_slaves::username}/tools/java/latest10":
    ...
    target => '/usr/local/asfpackages/java/jdk-10.0.1',
  }
  file { "/home/${build_slaves::username}/tools/java/latest11":
    ensure => link,
    target => '/usr/local/asfpackages/java/jdk-11-ea+19',
  }
  ...
  cron {
    ...
    'docker-cleanup-weekly':
      hour        => '20',
      command     => '/usr/bin/docker system prune -a -f --filter "until=72h"',
      environment => [
        'PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin',
        'SHELL=/bin/sh'
      ];
