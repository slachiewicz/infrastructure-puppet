...
class build_slaves::jenkins (
  ...
  $java_asfpackages = [
    ...
    'jdk1.5.0_22-32',
    'jdk1.5.0_22-64',
    'jdk1.6.0_20-32-unlimited-security',
    'jdk1.6.0_45-64',
    'jdk1.7.0-32',
    'jdk1.7.0-64',
    'jdk1.7.0_25-32',
    'jdk1.7.0_25-64',
    'jdk1.7.0_79-unlimited-security',
    'jdk1.7.0_80',
    'jdk1.8.0_66-unlimited-security',
    'jdk1.8.0_121',
    'jdk1.8.0_131',
    'jdk1.8.0_144',
  ...
  file { "/home/${build_slaves::username}/tools/java/latest12":
    ...
    target => '/usr/local/asfpackages/java/openjdk-12-ea+28',
  }
  file { "/home/${build_slaves::username}/tools/java/latest13":
    ensure => link,
    target => '/usr/local/asfpackages/java/openjdk-13-ea+4',
  }
